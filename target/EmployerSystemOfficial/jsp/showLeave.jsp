...
<div class="container">
    ...
    <div class="row">
        <div class="col-md-4 column">
            <a class="btn btn-primary" href="bossMenu.jsp">主页</a>
        </div>
    </div>
    <div class="row clearfix">
        <div class="col-md-12 column">
            <table class="table table-hover table-striped">
                ...
                <c:forEach var="list" items="${leaveList}">
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="/leaves/agree?employerId=${list.getEmployerId()}">批准</a>
                            |
                            <a href="/leaves/refuse?employerId=${list.getEmployerId()}">拒绝</a>
                            |
                            <a href="<c:url value="/leaves/download?file=${list.getEmployerLeaveFile()}"/>">下载请假文件</a>
                        </td>
                    </tr>
                    </tbody>
                </c:forEach>
