...
<div class="container">
    ...
    <form class="form-horizontal" action="/leaves/add" method="post" enctype="multipart/form-data">
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input type="text" class="form-control" id="employerLeaveReason" placeholder="请假内容" name="employerLeaveReason">
        </div>
    </div>
    <br/>
    <div class="form-group">
